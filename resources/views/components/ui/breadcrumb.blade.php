@php
  ...
  $breadcrumbMap = [
      ...
      'nhap-hang-online.index' => ['Đơn hàng Online', 'Nhập hàng'],
      'nhap-hang-online.create' => ['Đơn hàng Online', 'Thêm nhập hàng'],
      'nhap-hang-online.edit' => ['Đơn hàng Online', 'Sửa nhập hàng'],
      'don-hang-hoan-thanh.index' => ['Đơn hàng Online', 'Xuất hàng'],
      'don-hang-hoan-thanh.create' => ['Đơn hàng Online', 'Thêm xuất hàng'],
      'don-hang-hoan-thanh.edit' => ['Đơn hàng Online', 'Cập nhật xuất hàng'],
      'don-hang-hoan-thanh.import' => ['Đơn hàng Online', 'Import xuất hàng'],
      'hang-hoan-online.index' => ['Đơn hàng Online', 'Hàng hoàn'],
      'hang-hoan-online.create' => ['Đơn hàng Online', 'Thêm hàng hoàn'],
      'hang-hoan-online.edit' => ['Đơn hàng Online', 'Sửa hàng hoàn'],
      'hang-hoan-online.import' => ['Đơn hàng Online', 'Import hàng hoàn'],
      'hang-hoan-online.preview' => ['Đơn hàng Online', 'Xác nhận import hàng hoàn'],
      'ton-kho-online.index' => ['Đơn hàng Online', 'Tồn kho'],
      ...
      'bao-cao.ban-hang-online' => ['Báo cáo', 'Bán hàng online'],
