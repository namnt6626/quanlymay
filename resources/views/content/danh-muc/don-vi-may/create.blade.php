        ...
        <div class="row g-4">
          <div class="col-md-4">
            ...
            <input type="text" class="form-control @error('ma_don_vi') is-invalid @enderror" id="ma_don_vi"
              name="ma_don_vi" value="{{ old('ma_don_vi') }}" maxlength="50" required>
            @error('ma_don_vi')
          ...
          <div class="col-md-8">
            ...
            <input type="text" class="form-control @error('ten_don_vi') is-invalid @enderror" id="ten_don_vi"
              name="ten_don_vi" value="{{ old('ten_don_vi') }}" required>
            @error('ten_don_vi')
              <div class="invalid-feedback">{{ $message }}</div>
            @enderror
          </div>
