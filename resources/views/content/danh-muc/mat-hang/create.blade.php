        ...
        <form action="{{ route('mat-hang.store') }}" method="POST">
            ...
            <div class="row g-4">
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control @error('ma_hang') is-invalid @enderror" id="ma_hang" name="ma_hang" value="{{ old('ma_hang') }}" maxlength="50" required>
                    @error('ma_hang')
                ...
                <div class="col-md-8">
                    ...
                    <input type="text" class="form-control @error('ten_hang') is-invalid @enderror" id="ten_hang" name="ten_hang" value="{{ old('ten_hang') }}" required>
                    @error('ten_hang')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
