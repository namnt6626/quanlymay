        ...
        <form action="{{ route('mau.update', $mau) }}" method="POST">
            ...
            <div class="row g-4">
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control @error('ma_mau') is-invalid @enderror" id="ma_mau" name="ma_mau" value="{{ old('ma_mau', $mau->ma_mau) }}" maxlength="50" required>
                    @error('ma_mau')
                ...
                <div class="col-md-8">
                    ...
                    <input type="text" class="form-control @error('ten_mau') is-invalid @enderror" id="ten_mau" name="ten_mau" value="{{ old('ten_mau', $mau->ten_mau) }}" required>
                    @error('ten_mau')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-select @error('trang_thai') is-invalid @enderror" id="trang_thai" name="trang_thai" required>
                        <option value="1" @selected((string) old('trang_thai', (int) $mau->trang_thai) === '1')>Hoạt động</option>
                        <option value="0" @selected((string) old('trang_thai', (int) $mau->trang_thai) === '0')>Ngừng dùng</option>
                    </select>
                    @error('trang_thai')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
