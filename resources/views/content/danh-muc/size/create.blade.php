        ...
        <form action="{{ route('size.store') }}" method="POST">
            ...
            <div class="row g-4">
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control @error('ma_size') is-invalid @enderror" id="ma_size" name="ma_size" value="{{ old('ma_size') }}" maxlength="50" required>
                    @error('ma_size')
                ...
                <div class="col-md-8">
                    ...
                    <input type="text" class="form-control @error('ten_size') is-invalid @enderror" id="ten_size" name="ten_size" value="{{ old('ten_size') }}" required>
                    @error('ten_size')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
