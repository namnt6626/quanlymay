<!DOCTYPE html>
<html lang="en" class="layout-menu-fixed layout-compact layout-navbar-hidden"
  data-assets-path="{{ asset('/assets') . '/' }}" dir="ltr" data-skin="default" data-base-url="{{ url('/') }}"
  data-framework="laravel" data-bs-theme="light" data-template="vertical-menu-template">
